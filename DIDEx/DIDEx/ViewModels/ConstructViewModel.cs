...
{
    public class ConstructViewModel : BindableBase
    {
        ...
        public ObservableCollection<ConstructModel> VisibilityList { get; set; } = new ObservableCollection<ConstructModel>();
        List<ConstructListControl> deptList;
