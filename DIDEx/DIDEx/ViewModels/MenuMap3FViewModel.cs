...
{
	public class MenuMap3FViewModel : BindableBase, INavigationAware
    {
        IEventAggregator _ea;
        public ObservableCollection<MenuMap3FModel> MenuList { get; set; } = new ObservableCollection<MenuMap3FModel>();
        ...
        public MenuMap3FViewModel(IRegionManager regionManager, IEventAggregator ea)
        { 
            _ea = ea;
