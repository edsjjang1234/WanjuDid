...
{
	public class MenuMap4FViewModel : BindableBase, INavigationAware
    {
        IEventAggregator _ea;
        public ObservableCollection<MenuMap4FModel> MenuList { get; set; } = new ObservableCollection<MenuMap4FModel>();
        ...
        public MenuMap4FViewModel(IRegionManager regionManager, IEventAggregator ea)
        {
            _ea = ea;
